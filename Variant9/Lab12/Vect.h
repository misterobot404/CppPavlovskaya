...
public:
	explicit Vect() : first(0), last(0), markName("class Queue") {}
	...
	void mark(string& name) { markName = name; } // установить отладочное им€
	string mark() const { return markName; } // получить отладочное им€
